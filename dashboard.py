...
for interaction in interactionsDict:
	...
	for input in interaction['input']:
		...
		elif input['type'] == 'CTabs':
			inputLst.append(Input(inputId, 'value'))
		elif input['type'] == 'CDataTable':
			inputLst.append(Input(inputId, 'selected_row_incdices'))
		elif input['type'] == 'CChart':
			inputLst.append(Input(inputId, 'figure'))
		elif input['type'] == 'CTopologyMap':
			inputLst.append(Input(inputId, 'clickData'))
		elif input['type'] == 'CInterval':
			inputLst.append(Input(inputId, 'n_intervals'))
		'''
	stateLst = []
