...
myMonthlyResultChartFrame = CFrame('Monthly results chart', width = 0.5)
...
#myScreen = CFrame('Result overview')
myScreen = CPage(args.get('asset') + ' -- Result overview')
myScreen.aChild(myKPIFrame)
myScreen.aChild(myMonthlyResultChartFrame)
myScreen.aChild(myMonthlyResultValueFrame)
myScreen.aChild(myPriceFrame)
